...
declare namespace LiteMol.Visualization.Molecule.PaperChain {
    interface Parameters {
        tessalation?: number;
        atomRadius?: (i: number) => number;
        hideBonds?: boolean;
    ...
    const DefaultPaperChainModelParameters: Parameters;
    class Model extends Visualization.Model {
        private material;
        private bondsMaterial;
        private pickMaterial;
...
declare namespace LiteMol.Visualization.Molecule.PaperChain {
    function buildGeometry(model: Core.Structure.Molecule.Model, parameters: Parameters, atomIndices: number[], ctx: Core.Computation.Context): Promise<PaperChainGeometry>;
    class PaperChainGeometry extends GeometryBase {
        atomsGeometry: THREE.BufferGeometry;
        bondsGeometry: THREE.BufferGeometry;
        pickGeometry: THREE.BufferGeometry;
        atomVertexMap: Selection.VertexMap;
...
declare namespace LiteMol.Bootstrap.Visualization.Molecule {
    ...
    interface PaperChainParams extends DetailParams {
        useVDW: boolean;
        vdwScaling?: number;
        atomRadius?: number;
        bondRadius: number;
    ...
    namespace Default {
        ...
        const PaperChainParams: PaperChainParams;
...
declare namespace LiteMol.Bootstrap.Entity {
    ...
    namespace Molecule {
        ...
        const Visual: Type<Visual.Props<"Surface" | "PaperChain" | "Cartoons" | "Calpha" | "BallsAndSticks" | "VDWBalls"> & {
            tag?: any;
        }>;
