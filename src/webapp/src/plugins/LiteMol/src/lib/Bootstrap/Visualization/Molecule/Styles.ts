...
namespace LiteMol.Bootstrap.Visualization.Molecule {
    ...
    export const TypeDescriptions = {
        'PaperChain': { label: 'Paper Chain', shortLabel: 'Paper Chain' } as TypeDescription,
    ...
    export const Types: Type[] = ['PaperChain', 'Cartoons', 'Calpha', 'BallsAndSticks', 'VDWBalls', 'Surface' ];
    ...
    export interface PaperChainParams extends DetailParams {
        useVDW: boolean,
        vdwScaling?: number,
        atomRadius?: number,
        bondRadius: number,
    ...
    export namespace Default {        
        ...
        // @ts-ignore
        export const PaperChainParams:  PaperChainParams = {
            bondRadius: 0.09
        };
        ...
        export const ForType: Map<Type, Style<any>> = (function() {    
            let types = {
                ...
                'PaperChain': { type: 'PaperChain', params: PaperChainParams, theme: { template: ElementSymbolThemeTemplate, colors: ElementSymbolThemeTemplate.colors, transparency: Transparency, interactive: true } },
