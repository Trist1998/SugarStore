<template>
    <div style="width: 50%; height: 50%">
        <p>HELOO</p>
        <div id="viewer" style="width: 50%; height: 50%">
...
<script>
    import LiteMol from '@/plugins/LiteMol/build/web/assets/js/LiteMol-plugin'
    export default {
        name: "LiteMolViewer",
        data(){
            return {
...
<style scoped>
    @import '../plugins/LiteMol/build/web/assets/css/LiteMol-plugin.css';
    #viewer {
        position: relative;
        margin-top: 80px;
        margin-bottom: 400px;
